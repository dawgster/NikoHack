...
struct MTSlideToOpen: View {
    ...
    var text: String = "slide to open"
    var textFont: Font = .system(size: 15)
    //var textColor = Color(.sRGB, red: 25.0/255, green: 155.0/255, blue: 215.0/255, opacity: 0.7)
     //var textColor = Color(.sRGB, red: 5.0/255, green: 5.0/255, blue: 5.0/255, opacity: 0.7)
    var textColor = Color(.sRGB, red: 251/255, green: 61/255, blue: 57.0/255, opacity: 0.7)
   ...
   // var sliderBackgroundColor = Color(.sRGB, red: 0.1, green: 0.64, blue: 0.84, opacity: 0.1)
     var sliderBackgroundColor = Color(.sRGB, red: 0.1, green: 0.04, blue: 0.04, opacity: 0.1)
    ...
    private func setupView(geometry: GeometryProxy) -> some View {
        ...
        return HStack {
                ZStack(alignment: .leading, content: {
                    ...
                    //Image(iconName)
                    Image(systemName: "cube.box.fill").colorInvert()
                    .frame(maxWidth: .infinity, maxHeight: .infinity)
